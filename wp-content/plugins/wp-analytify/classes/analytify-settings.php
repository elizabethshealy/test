			...
			$settings_fields = array(
				...
				'wp-analytify-profile' => array(
					array(
						...
						'desc'              => apply_filters( 'analytify_install_ga_text', __( 'Insert Google Analytics JS code in header to track the visitors. You can uncheck this option if you have already insert the GA code in your website.', 'wp-analytify' ) ),
						'type'              => 'checkbox',
						),
					array(
